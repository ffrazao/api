...
describe('FotografoDeFaces — Trocar -> Cancelar (§13.7)', () => {
...
describe('FotografoDeFaces — Limpar -> onChange(null) -> Confirmar (§13.8)', () => {
  it('consolida o estado limpo sem precisar de uma nova captura', () => {
    const original = fakePhoto('original')
    render(<Host initialValue={original} autoCaptureAfter={null} reviewFor={3000} />)
